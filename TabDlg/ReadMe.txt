================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TabDlg プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TabDlg には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TabDlg アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TabDlg.h
   ...
   CTabDlgApp アプリケーション クラスを宣言します。

TabDlg.cpp
   これは、アプリケーション クラス CTabDlgApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TabDlg.ico
   ...
   アイコンはメイン リソース ファイル TabDlg.rc に含まれていま
   す。
...
TabDlgDlg.h, TabDlgDlg.cpp - ダイアログ
   これらのファイルは CTabDlgDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TabDlg.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TabDlg.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
